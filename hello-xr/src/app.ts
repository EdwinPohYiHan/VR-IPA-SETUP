import {
    ArcRotateCamera, Color3, CubeTexture, Engine, MeshBuilder, Scene,
    StandardMaterial, Texture, Vector3, UniversalCamera, HemisphericLight,
    PointLight, VideoDome, SceneLoader, AbstractMesh, Animation,
    ParticleSystem, Color4, Sound
} from "babylonjs";
...
export class App {
    ...
    {
        const music = new Sound('music', 'assets/sounds/hello-xr.mp3', scene, null, {
